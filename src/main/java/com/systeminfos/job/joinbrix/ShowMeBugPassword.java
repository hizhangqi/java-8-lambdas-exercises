...
public class ShowMeBugPassword {
    ...
    public String solution2(String password) {
        String result = "weak";
...
//        System.out.println(password.solution1("!Abcdefgh123456cbA"));
        ...
        System.out.println(password.solution2(null));
        System.out.println(password.solution2("Abc1234"));
        System.out.println(password.solution2("Abcdefgh1234567890qwer"));
        System.out.println(password.solution2("Abcdefgh1234567890qwert"));
        System.out.println(password.solution2("Abcdefgh123456cbA"));
        System.out.println(password.solution2("!Abcdefgh123456cbA"));
    }
